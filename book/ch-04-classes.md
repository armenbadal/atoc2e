...
Կոմպլեքս թվեր հետ աշխատող գործողությունները կոմպիլյատորը փոխարինում է համապատասխան ֆունկցիաների կանչերով. Օրինակ, `c!=b`-ն նշանակում է `operator!=(c,b)`, իսկ `1/a`- նշանակում է `operator/(complex{1},a)`։
