...
Կոնստրուկտորը հիշողություն է առանձնացնում `Vector`-ի տարրերի համար և դրանք պետք եղած ձևով սկզբնարժեքավորում է։ Դեստրուկտորը հետ է վերադարձնում տարրերի հիշողությունը։ 
