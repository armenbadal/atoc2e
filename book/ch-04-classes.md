...
`Container`-ի օրինակը դասերի հիերարխիայի շատ պարզ դեպք է։ _Դասերի հիերարխիան_ ածանցման (օր. `: public`) միջոցով ստեղծված և ցանցի տեսքով կազմակերպված դասերի բազմություն է։ Դասերի հիերարխիաներն օտագործում ենք հիերարխիկ հարաբերություններ ունեցեղ կոնցեպտների, ինչպիսիք են «Հրշեջ մեքենան ավտոմեքենայի տեսակ է, որն էլ փոխադրամիջոցի տեսակ է» կամ «Ժպտիկը շրջանի մի տեսակ է, որն էլ պատկերի տեսակ է», ներկայացման համար։ ?? Հաճախ են հանդիպում լայնությամբ ու խորությամբ տարածված հարյուրավոր անդամներով դասերի հիերախիաները։ Որպես կիսաիրական դասական մի օրինակ, եկեք դիտարկենք երկրաչափական պատկաերներն էկրանի վրա.
...
```C++
class Smiley : public Circle {  // շրջանագիծը դեմքի բազային դասն է
public:
...
Ուշադրություն դարձրեք, թե ինչպես է `Smiley`-ն իր աչքերը պահում ստանդարտ գրադարանի `vector`-ում և դրանք ջնջում է իր դեստրուկտորում։ `Shape`-ի դեստրուկտորը վիրտուալ էև `Smiley`-ի դեստրուկտորը փոխարինում է այն։ Վերացական դասի համար վիրտուալ դեստրուկտորը պարտադիր է, քանի որ ածանցված դասի օբյեկտը սովորաբար կառավարվում է իր վերացական բազային դասի տրամադրած ինտերֆեյսով։ Մասնավորապես, այդ օբյեկտը կարող է ջնջվել բազային դասի ցուցիչի միջոցով։ ?? Բացի այդ, վիրտուալ ֆունկցիայի կանչի մեխանիզմը երաշխավորում է, որ ճիշտ կոնստրուկտորն է կանչվել։ ?? Այնուհետև դեստրուկտորը ոչ բացահայտ կերպով կանչում է իր բազային դասերի ու անդամների դեստրուկտորները։
...
Դասերի հիերարխիան տրամադրում երկու տեսակի առավելություններ.
...
* _Իրականացման ժառանգում։_ Բազային դասը ֆունկցիաներ և տվյալներ է տրամադրում, որոնք պարզեցնում են ածանցվող դասերի իրականացումը։ Դր օրինակներ են `Smiley`-ի կողմից `Circle`-ի կոնստրուկտորի և `Circle::draw()`-ի օգտագործումը։ Այդպիսի բազային դասերը սովորաբար ունենում են անդամ-տվյալներ և կոնստրուկտորներ։

Կոնկրետ դասերը, հատկապես փոքր ներկայացմամբ դասերը, շատ նման են ներդրված տիպերին. մենք դրանց սահմանում ենք որպես տեղային (լոկալ) փոփոխականներ, դրանց դիմում ենք իրենց անուններով, դրանք պատճենում ենք և այլն։ Դասերի հիերարխիայում դասերը տարբեր են. մենք հակված ենք դրանց `new` գործողությամբ ստեղծել հիշողության ազատ տիրույթում, և դրանց դիմում ենք ցուցիչներով ու հղումներով։ Օրինակ, դիտարկենք մի ֆունկցիա, որը ներմուծման հիսքից կարդում է պատկերները նկարագրող տվյալները և կառուցում է համապատասխան `Shape` օբեկտները.

```C++
enum class Kind { circle, triangle, smiley };

Shape* read_shape(istream& is)   // ներմուծման is հոսքից կարդակ պատկերների նկարագրությունները
{
    ...
    case Kind::smiley:
        // ժպտիկի {Point,int,Shape,Shape,Shape} տվյալները կարդալ p-ի, r-ի, e1-ի, e2-ի և m-ի մեջ
